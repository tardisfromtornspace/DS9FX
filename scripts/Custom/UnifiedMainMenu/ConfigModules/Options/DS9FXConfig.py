...
lSettings = ['ExcaliburSelection','DefiantSelection','OregonSelection','LakotaSelection',
             ...
             'KlingonSide', 'CardassianSide','SeptimusPlanets','SeptimusNanoFX','SeptimusMapPlanetDetail','SeptimusMusic',
...
def CreateDS9MapRelated(pOptionPane, pContentPanel):
        ...
        dButtons['170'] = CreateStateButton(App.TGString("Max Number Of Enemies: "), "MaxRandShips", [App.TGString("2"), App.TGString("4")], DS9FXUnsavedConfig.MaxRandShips)
        pDS9RndFleet.AddChild(dButtons['170'])        
...
def CreateSeptimusMapRelated(pOptionPane, pContentPanel):
        ...
        dButtons['155'] = CreateStateButton(App.TGString("Planets: "), "SeptimusPlanets", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.SeptimusPlanets)
        pPlanets.AddChild(dButtons['155'])

        dButtons['156'] = CreateStateButton(App.TGString("NanoFX Atmospheres: "), "SeptimusNanoFX", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.SeptimusNanoFX)
        pPlanets.AddChild(dButtons['156'])

        dButtons['157'] = CreateStateButton(App.TGString("Detail: "), "SeptimusMapPlanetDetail", [App.TGString("Lowest"), App.TGString("Low"), App.TGString("Standard"), App.TGString("High")], DS9FXUnsavedConfig.SeptimusMapPlanetDetail)
        pPlanets.AddChild(dButtons['157'])

        dButtons['158'] = CreateStateButton(App.TGString("Selection: "), "SeptimusMusic", [App.TGString("Off"), App.TGString("Music 1"), App.TGString("Music 2"), App.TGString("Random")], DS9FXUnsavedConfig.SeptimusMusic)
        pMusic.AddChild(dButtons['158'])
...
def CreatePelosaMapRelated(pOptionPane, pContentPanel):
        ...
        dButtons['163'] = CreateStateButton(App.TGString("Planets: "), "PelosaPlanets", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.PelosaPlanets)
        pPlanets.AddChild(dButtons['163'])

        dButtons['164'] = CreateStateButton(App.TGString("NanoFX Atmospheres: "), "PelosaNanoFX", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.PelosaNanoFX)
        pPlanets.AddChild(dButtons['164'])

        dButtons['165'] = CreateStateButton(App.TGString("Detail: "), "PelosaMapPlanetDetail", [App.TGString("Lowest"), App.TGString("Low"), App.TGString("Standard"), App.TGString("High")], DS9FXUnsavedConfig.PelosaMapPlanetDetail)
        pPlanets.AddChild(dButtons['165'])

        dButtons['166'] = CreateStateButton(App.TGString("Selection: "), "PelosaMusic", [App.TGString("Off"), App.TGString("Music 1"), App.TGString("Music 2"), App.TGString("Random")], DS9FXUnsavedConfig.PelosaMusic)
        pMusic.AddChild(dButtons['166'])
...
def CreateDonatuMapRelated(pOptionPane, pContentPanel):
        ...
        dButtons['159'] = CreateStateButton(App.TGString("Planets: "), "DonatuPlanets", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.DonatuPlanets)
        pPlanets.AddChild(dButtons['159'])

        dButtons['160'] = CreateStateButton(App.TGString("NanoFX Atmospheres: "), "DonatuNanoFX", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.DonatuNanoFX)
        pPlanets.AddChild(dButtons['160'])

        dButtons['161'] = CreateStateButton(App.TGString("Detail: "), "DonatuMapPlanetDetail", [App.TGString("Lowest"), App.TGString("Low"), App.TGString("Standard"), App.TGString("High")], DS9FXUnsavedConfig.DonatuMapPlanetDetail)
        pPlanets.AddChild(dButtons['161'])

        dButtons['162'] = CreateStateButton(App.TGString("Selection: "), "DonatuMusic", [App.TGString("Off"), App.TGString("Music 1"), App.TGString("Music 2"), App.TGString("Random")], DS9FXUnsavedConfig.DonatuMusic)
        pMusic.AddChild(dButtons['162'])
...
def CreateStarbase375MapRelated(pOptionPane, pContentPanel):
        ...
        dButtons['167'] = CreateStateButton(App.TGString("Starbase 375: "), "Starbase375Starbase", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.Starbase375Starbase)
        pObjects.AddChild(dButtons['167'])

        dButtons['168'] = CreateStateButton(App.TGString("USS Centaur: "), "Starbase375Centaur", [App.TGString("No"), App.TGString("Yes")], DS9FXUnsavedConfig.Starbase375Centaur)
        pObjects.AddChild(dButtons['168'])

        dButtons['169'] = CreateStateButton(App.TGString("Selection: "), "Starbase375Music", [App.TGString("Off"), App.TGString("Music 1"), App.TGString("Music 2"), App.TGString("Random")], DS9FXUnsavedConfig.Starbase375Music)
        pMusic.AddChild(dButtons['169'])
...
def CreateMiscOptions(pOptionPane, pContentPanel):
        ...
        for k,v in dIntro.items():                    
                if (v[1] == DS9FXUnsavedConfig.IntroMovieSel):
                        dButtons['47'].SetName(App.TGString("Intro Override:  " + v[0]))
                        break
...
def CreateExtras(pOptionPane, pContentPanel):
        ...
        dButtons['171'] = CreateButton("Xtended 1.1 Completion Video", pMainMenu, pOptionPane, pContentPanel, __name__ + ".ExtraVid8", EventInt = 0)
        ...
        dButtons['172'] = CreateButton("Xtended 1.1 Intro Video", pMainMenu, pOptionPane, pContentPanel, __name__ + ".ExtraVid9", EventInt = 0)
...
def SetIntroOverride(pObject, pEvent):
        ...
        dButtons['47'].SetName(App.TGString("Intro Override:  " + dIntro[iCounter][0]))
...
def CheckShownOptions():
        ...
        if DS9FXUnsavedConfig.RandomEnemyFleetAttacks == 1:
                ...
                if not dButtons['170'].IsEnabled():
                        dButtons['170'].SetEnabled()                        
        else:
                ...
                if dButtons['170'].IsEnabled():
                        dButtons['170'].SetDisabled()                        
        ...
        if DS9FXUnsavedConfig.SeptimusPlanets == 1:
                if not dButtons['156'].IsEnabled():
                        dButtons['156'].SetEnabled()
                if not dButtons['157'].IsEnabled():
                        dButtons['157'].SetEnabled()
        else:
                if dButtons['156'].IsEnabled():
                        dButtons['156'].SetDisabled()
                if dButtons['157'].IsEnabled():
                        dButtons['157'].SetDisabled()        
                        
        if DS9FXUnsavedConfig.DonatuPlanets == 1:
                if not dButtons['160'].IsEnabled():
                        dButtons['160'].SetEnabled()
                if not dButtons['161'].IsEnabled():
                        dButtons['161'].SetEnabled()
        else:
                if dButtons['160'].IsEnabled():
                        dButtons['160'].SetDisabled()
                if dButtons['161'].IsEnabled():
                        dButtons['161'].SetDisabled()    
                        
        if DS9FXUnsavedConfig.PelosaPlanets == 1:
                if not dButtons['164'].IsEnabled():
                        dButtons['164'].SetEnabled()
                if not dButtons['165'].IsEnabled():
                        dButtons['165'].SetEnabled()
        else:
                if dButtons['164'].IsEnabled():
                        dButtons['164'].SetDisabled()
                if dButtons['165'].IsEnabled():
                        dButtons['165'].SetDisabled()                          
