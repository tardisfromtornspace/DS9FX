...
from Custom.DS9FX.DS9FXLib import DS9FXMenuLib, DS9FXCleanLeftover, DS9FXCometAlpha, DS9FXDisableEndCombat, DS9FXKillSets, DS9FXMirrorUniverse, DS9FXNebula, DS9FXSets, LogConsole, FixExitGame, FixNanoFXExplosions, Mvam_Wormhole_Fix, PopulateGroups, StabilizationCode, SetGamePlayerFix
...
from Custom.DS9FX.DS9FXObjects import BorgShips, ResetWormholeSpecificAIs
...
# ET_PRE_WORMHOLE_ENTRY related
def PreWormholeEntryHandling(pObject, pEvent):
        ResetWormholeSpecificAIs.ResetAllAIs()
...
def CanStart():
        ...
        if pMission:
                if string.find(pMission.GetScript(), "Multiplayer") != -1:
                        retVal = 0
