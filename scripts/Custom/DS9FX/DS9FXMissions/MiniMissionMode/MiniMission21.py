...
def MissionHandler(pObject, pEvent):
    ...
    if pSystemName == mSystems[0]:
        ...
        if iRand != 2:  # 33% chance of not creating attackers.
            ...
            MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateShips",
                                   App.g_kUtopiaModule.GetGameTime() + time, 0, 0)
...
def CreateDerelict():
    ...
    MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".DamageDerelict",
...
def StartScanning():
    ...
    MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".StopScanning",
                           App.g_kUtopiaModule.GetGameTime() + iRand, 0, 0)
