                ...
                if iStatus == 1:
                    ...
                    if Lexington:
                        ...
                        if pPlanet:
                            ...
                            pCon = App.ConditionScript_Create("Conditions.ConditionInRange", "ConditionInRange", 250,
                                                              pPlanet.GetName(), Lexington.GetName())
    ...
    if (pShip != None):
        if pPlayer.GetObjID() == pShip.GetObjID():
            ...
            if pSystemName == "DS9FXNewBajor1" and iStatus == 0:
                ...
                MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".Reinforcements",
                                       App.g_kUtopiaModule.GetGameTime() + 10, 0, 0)
                iStatus = 2
...
def LexingtonInRange(bInRange):
    ...
    MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".TransportDone",
                           App.g_kUtopiaModule.GetGameTime() + 12, 0, 0)
    pSequence.Play()
    return 0
...
def RemoveMissionShips():
    ships = ["USS Lexington", "Renegade Base", "USS Thunderbird", "USS Discovery"]
