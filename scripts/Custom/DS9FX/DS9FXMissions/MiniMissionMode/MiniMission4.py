...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: The Dogs of War"),
    ...
    pText = App.TGParagraph_CreateW(
        App.TGString("-Intercept USS Malinche\n-Disable USS Malinche\n-USS Malinche mustn't be destroyed"),
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "Captain Sanders of the USS Malinche has gone rogue! After the loss of his son at the second Battle of Chin'toka, he has sworn to take revenge on the Cardassians. He has targetted a medical convoy soon entering Bajoran space. You are ordered to stop him at all costs!"),
...
def MissionSetup():
    ...
    pCondition = App.ConditionScript_Create("Conditions.ConditionSystemDisabled", "ConditionSystemDisabled",
                                            "USS Malinche", App.CT_IMPULSE_ENGINE_SUBSYSTEM, 1)
