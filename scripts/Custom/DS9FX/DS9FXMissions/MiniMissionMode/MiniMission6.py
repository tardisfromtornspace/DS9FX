...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Section 31"), 0.0,
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "A Dominion delegation is coming over to DS9 in a hope to start the healing process between us. Not everybody approves this! The infamous Section 31 seems to be trying to sabotage this. We have received word that they have dispatched a starship to spoil this, destroy this ship immediately Captain. We must stop Section 31 at all costs or they could risk another war."),
