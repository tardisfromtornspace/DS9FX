...
lSets = ["GammaQuadrant1", "DS9FXKaremma1", "DS9FXDosi1", "DS9FXYadera1", "DS9FXNewBajor1", "DS9FXGaia1",
         "DS9FXKurill1", "DS9FXTrialus1", "DS9FXTRogoran1", "DS9FXVandros1", "DS9FXFoundersHomeworld1"]
lShips = [DS9FXShips.DomBC, DS9FXShips.Bugship]
lFriendly = [DS9FXShips.Akira, DS9FXShips.Centaur, DS9FXShips.Defiant, DS9FXShips.Excelsior, DS9FXShips.Galaxy,
             DS9FXShips.Miranda, DS9FXShips.Nebula, DS9FXShips.Sovereign]
lObjective = []
lType = []
lFType = []
lFObjective = []
