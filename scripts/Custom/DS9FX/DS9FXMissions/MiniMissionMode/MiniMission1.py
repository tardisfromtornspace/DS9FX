...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                               App.TGString("Mission: Procure Ketracel White"), 0.0, 0.0, None, 1, 0.30,
                                               0.30, kColor)
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "Your mission is to travel to the Gamma Quadrant and engage a Dominion ship carrying Ketracel White. Return it to the DS9 System to complete the mission."),
