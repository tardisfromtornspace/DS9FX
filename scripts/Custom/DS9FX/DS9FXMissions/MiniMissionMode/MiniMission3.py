...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                               App.TGString("Mission: The tides of Idran"), 0.0, 0.0, None, 1, 0.30,
                                               0.30, kColor)
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "This is a difficult assignment, Captain. You are required to enter the wormhole and stop incoming Jem'Hadar ships before they can enter the Alpha Quadrant. We suspect that this is one desperate attempt of the Dominion to send reinforcements to their friends in the Alpha Quadrant. Stop them at ALL costs!"),
...
def MissionPlacement(pObject, pEvent):
    ...
    sShips = ['Dominion 1', 'Dominion 2', 'Dominion 3', 'Dominion 4', 'Dominion 5', 'Dominion 6', 'Dominion 7',
              'Dominion 8', 'Dominion 9', 'Dominion 10', 'Dominion 11', 'Dominion 12', 'Dominion 13', 'Dominion 14',
              'Dominion 15', 'Dominion 16', 'Dominion 17', 'Dominion 18']
