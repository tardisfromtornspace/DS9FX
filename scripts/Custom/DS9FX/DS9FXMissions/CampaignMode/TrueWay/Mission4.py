...
def InOrbit(bInOrbit):
    ...
    ShowMessage("I'm scanning Empok Nor. I'm not detecting anything. There is nothing in the enemy wreckage either. I don't think the shipment arrived here.\n\nWe should return to DS9 for further instructions.", 20)       
