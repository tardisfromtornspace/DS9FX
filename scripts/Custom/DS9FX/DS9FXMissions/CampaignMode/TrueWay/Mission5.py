...
def RemoveMissionShips():
    ships = ["USS Kennedy", "USS Venice", "USS Monitor", "Empok Nor", "Fighter 1", "Fighter 2", "Fighter 3",
             "Fighter 4", "Keldon 1", "Keldon 2", "Keldon 3", "Keldon 4"]
