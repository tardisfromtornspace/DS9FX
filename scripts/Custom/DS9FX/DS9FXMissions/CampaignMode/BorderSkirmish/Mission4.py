...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                               App.TGString("Mission: Revenge Is A Dish Best Served Cold"), 0.0, 0.0,
                                               None, 1, 0.30, 0.30, kColor)
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "Things have gone from bad to worse, Captain. The destruction of the White facility was not the big victory we expected it to be. The Founders have dispatched a wing of ships to help you find and destroy them. Ah, there they are..."),
...
def MissionInitiate(pObject, pEvent):
    ...
    pTimer1 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".SupportShipsIncoming",
                                     App.g_kUtopiaModule.GetGameTime() + 95, 0, 0)
    pTimer2 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".SupportArriving",
                                     App.g_kUtopiaModule.GetGameTime() + 41, 0, 0)
    pTimer3 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".firstEnemyWave",
                                     App.g_kUtopiaModule.GetGameTime() + 17, 0, 0)
    pTimer4 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".secondEnemyWave",
                                     App.g_kUtopiaModule.GetGameTime() + 40, 0, 0)
    pTimer5 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".thirdEnemyWave",
                                     App.g_kUtopiaModule.GetGameTime() + 293, 0, 0)
    pTimer6 = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".fourthEnemyWave",
                                     App.g_kUtopiaModule.GetGameTime() + 317, 0, 0)
    ...
    App.g_kEventManager.AddBroadcastPythonFuncHandler(DS9FXGlobalEvents.ET_SHIP_DEAD_IN_SPACE, pMission,
                                                      __name__ + ".ObjectExploding")
    App.g_kEventManager.AddBroadcastPythonFuncHandler(DS9FXGlobalEvents.ET_SHIP_TAKEN_OVER, pMission,
                                                      __name__ + ".DS9Exploding")
    App.g_kEventManager.AddBroadcastPythonFuncHandler(DS9FXGlobalEvents.ET_SHIP_DEAD_IN_SPACE, pMission,
                                                      __name__ + ".DS9Exploding")

    RenegadeShips = ["Renegade 1", "Renegade 2", "Renegade 3", "Renegade 4", "Renegade 5", "Renegade 6", "Renegade 7",
                     "Renegade 8", "Renegade 9", "Renegade 10", "Renegade 11", "Renegade 12", "Renegade 13",
                     "Renegade 14", "Renegade 15", "Renegade 16", "Renegade 17", "Renegade 18", "Renegade 19",
                     "Renegade 20"]
...
def RemoveMissionShips():
    ships = ["USS Antartica", "USS Washington", "USS Avenger", "Renegade 1", "Renegade 2", "Renegade 3", "Renegade 4",
             "Renegade 5", "Renegade 6", "Renegade 7", "Renegade 8", "Renegade 9", "Renegade 10", "Renegade 11",
             "Renegade 12", "Renegade 13", "Renegade 14", "Renegade 15", "Renegade 16", "Renegade 17", "Renegade 18",
             "Renegade 19", "Renegade 20"]
