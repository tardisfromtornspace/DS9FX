...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: A Time To Fight"),
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "The Klingons and Romulans have dispatched a contigent of their ships to DS9. You are ordered to take command of the taskforce, head to the Gamma Quadrant and put an end to that base once and for all."),
...
def BackToDS9(pObject, pEvent):
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".RemoveFriendlyShips",
                               App.g_kUtopiaModule.GetGameTime() + 10, 0, 0)
...
def RemoveMissionShips():
    ships = ["Bugship 4", "Bugship 5", "Bugship 6", "Bugship 7", "Battlecruiser", "Ketracel White Facility",
             "USS Croatia", "USS Molotov", "IKV Qo'Joh", "RIS Ptarmigan"]
