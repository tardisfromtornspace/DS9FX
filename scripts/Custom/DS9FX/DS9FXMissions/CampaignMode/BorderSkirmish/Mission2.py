...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Investigations"),
...
def MissionStart(pObject, pEvent):
    ...
    if (pSet.GetName() == "GammaQuadrant1"):
        ...
        pTimer = MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".AreaScanned",
                                        App.g_kUtopiaModule.GetGameTime() + 300, 0, 0)
