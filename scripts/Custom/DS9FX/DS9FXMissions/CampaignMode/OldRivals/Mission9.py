...
def MissionHandler(pObject, pEvent):
    ...
    if pSet.GetName() == "GammaQuadrant1":
        DominionText()
        MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateDominion",
                               App.g_kUtopiaModule.GetGameTime() + 10, 0, 0)
        MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".DeleteDominion",
                               App.g_kUtopiaModule.GetGameTime() + 10, 0, 0)
        MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".DominionPrompt",
...
def PrepareForBorg(bCanStay=1):
    ...
    BorgText()
    MissionLib.CreateTimer(DS9FXMenuLib.GetNextEventType(), __name__ + ".BorgTimer",
...
def RemoveMissionShips():
    ships = ["USS Icarus", "USS Tungsten", "USS Aberdeen", "USS Wanderer", "Borg Cube", "Dreadnought", "Escort 1",
             "Escort 2", "Escort 3"]
