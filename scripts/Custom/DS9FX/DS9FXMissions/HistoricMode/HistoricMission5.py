...
def CreateEntries(pObject, pEvent):
    ...
    pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                               App.TGString("Mission: The Way of the Warrior"), 0.0, 0.0, None, 1, 0.30,
                                               0.30, kColor)
    ...
    pText = App.TGParagraph_CreateW(
        App.TGString("-Take control of DS9\n-Hold off the Klingon ships until reinforcements arrive"),
    ...
    pText = App.TGParagraph_CreateW(App.TGString(
        "The Klingons have withdrawn from the Khitomer Accords after we have found out about their plans to invade Cardassia. The Klingon fleet which was briefly stationed here is turning against us. Take control of the DS9 to repel the invaders. You only need to hold them off until Federation Starships can arrive."),
...
def MissionSetup():
    ...
    sShips = ["IKS TuQmeh", "IKS Jawbogh", "IKS NabVad", "IKS Qu'ta'Dl'Hegh", "IKS QumHa'bogh", "IKS Qochbe'meH",
              "IKS QuSmey", "IKS Dotlh", "IKS Vuplu'bejnes", "IKS Qo'Joh", "IKS Satlho'Qu'tlh", "IKS IwwIj'ay'Hom"]
...
def RemoveMissionShips():
    ships = ["IKS TuQmeh", "IKS Jawbogh", "IKS NabVad", "IKS Qu'ta'Dl'Hegh", "IKS QumHa'bogh", "IKS Qochbe'meH",
             "IKS QuSmey", "IKS Dotlh", "IKS Vuplu'bejnes", "IKS Qo'Joh", "IKS Satlho'Qu'tlh", "IKS IwwIj'ay'Hom"]
