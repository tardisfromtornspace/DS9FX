...
def init():
        ...
        if DS9FXSavedConfig.FederationSide == 1:
                if DS9FXSavedConfig.DominionSide == 1:
                        if DS9FXSavedConfig.Starbase375Starbase == 1:
                                ...
                                bDockTOS375 = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Dock To Starbase 375", "Helm", __name__ + ".DockToS375", mS375SubMenu)
                                kDockTOS375 = DS9FXLib.DS9FXMenuLib.ColorizeButton(bDockTOS375, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25, 0.25, 1.0) 
                        else:                        
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow5", App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
...
def DockToS375(pObject, pEvent):
        ...
        MissionLib.SetPlayerAI("Helm", AI.Compound.DockWithStarbase.CreateAI(pPlayer, pBase, pDockingAction, bNoRepair = 0, bFadeEnd = 1))               
...
def CreateWindow5(pObject, pEvent):
        ...
        MissionWindow5 = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Campaign Mission Selection Menu"), 0.0, 0.0, None, 1, 0.50, 0.65, kColor)
        pTCW = App.TacticalControlWindow_GetTacticalControlWindow()
        pTCW.AddChild(MissionWindow5, 0.25, 0.25)
...
def CreateWindow5PartII(pObj, pEvent):
        ...
        x = 0
        y = 0.01
        dTrueWay['1'] = App.TGParagraph_CreateW(App.TGString("Please Select a Mission. Remember that the Campaign Mode remembers your last used ship and you cannot switch ships later. Missions have to be unlocked one by one."), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        MissionWindow5.AddChild(dTrueWay['1'], x, y, 0)

        textx = 0
        texty = 0.10
        dTrueWay['2'] = App.TGParagraph_CreateW(App.TGString("Mission 1: Pink Slips"), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        ...
        textx = 0
        texty = texty + 0.06
        dTrueWay['7'] = App.TGParagraph_CreateW(App.TGString("Mission 2: On the Border"), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        ...
        textx = 0
        texty = texty + 0.06
        dTrueWay['9'] = App.TGParagraph_CreateW(App.TGString("Mission 3: Gunships"), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        ...
        textx = 0
        texty = texty + 0.06
        dTrueWay['11'] = App.TGParagraph_CreateW(App.TGString("Mission 4: Payback"), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        ...
        textx = 0
        texty = texty + 0.06
        dTrueWay['13'] = App.TGParagraph_CreateW(App.TGString("Mission 5: The Battle of Septimus"), MissionWindow5.GetMaximumInteriorWidth(), None, '', MissionWindow5.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
