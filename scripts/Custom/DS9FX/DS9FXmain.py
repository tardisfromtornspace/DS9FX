...
ET_CAMPAIGN_3 = App.UtopiaModule_GetNextEventType()
...
ET_WINDOW_CLOSE_5 = App.UtopiaModule_GetNextEventType()
...
ET_TRUE_WAY_1 = App.UtopiaModule_GetNextEventType()
ET_TRUE_WAY_2 = App.UtopiaModule_GetNextEventType()
ET_TRUE_WAY_3 = App.UtopiaModule_GetNextEventType()
ET_TRUE_WAY_4 = App.UtopiaModule_GetNextEventType()
ET_TRUE_WAY_5 = App.UtopiaModule_GetNextEventType()
...
sAsteroidList = ["ships.Asteroid", "ships.Asteroid1", "ships.Asteroid2", "ships.Asteroid3", "ships.Asteroidh1",
                 "ships.Asteroidh2", "ships.Asteroidh3"]
...
def init():
    ...
    pKira.AddPythonFuncHandlerForInstance(ET_CAMPAIGN_3, __name__ + ".ChooseCampaign3")
    pKiraMenu.AddChild(CreateBridgeMenuButton(pMissionDatabase.GetString("TrueWay"), ET_CAMPAIGN_3, 0, pKira))
    ...
    pKiraMenu.AddChild(
        CreateBridgeMenuButton(pMissionDatabase.GetString("HistoricMissions"), ET_HISTORIC_MISSION, 0, pKira))
    ...
    kYadera = DS9FXLib.DS9FXMenuLib.ColorizeButton(bYadera, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25, 0.25,
                                                   1.0)
    bVandros = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Vandros System", "Helm", __name__ + ".WarpToVandros",
                                                            mWarpTo)
    kVandros = DS9FXLib.DS9FXMenuLib.ColorizeButton(bVandros, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                    0.25, 1.0)
    bTrialus = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Trialus System", "Helm", __name__ + ".WarpToTrialus",
                                                            mWarpTo)
    kTrialus = DS9FXLib.DS9FXMenuLib.ColorizeButton(bTrialus, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                    0.25, 1.0)
    bTRogoran = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("T-Rogoran System", "Helm", __name__ + ".WarpToTRogoran",
                                                             mWarpTo)
    kTRogoran = DS9FXLib.DS9FXMenuLib.ColorizeButton(bTRogoran, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                     0.25, 1.0)
    bNewBajor = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("New Bajor System", "Helm", __name__ + ".WarpToNewBajor",
                                                             mWarpTo)
    kNewBajor = DS9FXLib.DS9FXMenuLib.ColorizeButton(bNewBajor, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                     0.25, 1.0)
    bKurrill = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Kurill System", "Helm", __name__ + ".WarpToKurrill",
                                                            mWarpTo)
    kKurrill = DS9FXLib.DS9FXMenuLib.ColorizeButton(bKurrill, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                    0.25, 1.0)
    bKaremma = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Karemma System", "Helm", __name__ + ".WarpToKaremma",
                                                            mWarpTo)
    kKaremma = DS9FXLib.DS9FXMenuLib.ColorizeButton(bKaremma, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                    0.25, 1.0)
    ...
    bFounders = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Founders Homeworld", "Helm", __name__ + ".WarpToFounders",
                                                             mWarpTo)
    kFounders = DS9FXLib.DS9FXMenuLib.ColorizeButton(bFounders, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                     0.25, 1.0)
    ...
    kIdran = DS9FXLib.DS9FXMenuLib.ColorizeButton(bIdran, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25, 0.25,
                                                  1.0)
    ...
    bScanRegion = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Scan System", "Helm", __name__ + ".ScanSystem",
                                                               mScanSubMenu)
    kScanRegion = DS9FXLib.DS9FXMenuLib.ColorizeButton(bScanRegion, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25,
                                                       0.25, 0.25, 1.0)
    bScanPlanet = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Scan Planet", "Helm", __name__ + ".ScanPlanet",
                                                               mScanSubMenu)
    kScanPlanet = DS9FXLib.DS9FXMenuLib.ColorizeButton(bScanPlanet, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25,
                                                       0.25, 0.25, 1.0)
    bScanPlayer = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Scan Myself", "Helm", __name__ + ".ScanPlayerShip",
                                                               mScanSubMenu)
    kScanPlayer = DS9FXLib.DS9FXMenuLib.ColorizeButton(bScanPlayer, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25,
                                                       0.25, 0.25, 1.0)
    ...
    if DS9FXSavedConfig.LifeSupport == 1:
        ...
        bTransferCrew = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Transfer Crew", "Helm",
                                                                     __name__ + ".TransferCrewGUI", mTransferSubMenu)
        kTransferCrew = DS9FXLib.DS9FXMenuLib.ColorizeButton(bTransferCrew, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0,
                                                             0.25, 0.25, 0.25, 1.0)
        bRecoverShip = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Recover Ship", "Helm", __name__ + ".ShipRecovery",
                                                                    mTransferSubMenu)
        kRecoverShip = DS9FXLib.DS9FXMenuLib.ColorizeButton(bRecoverShip, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0,
                                                            0.25, 0.25, 0.25, 1.0)
        bCaptureShip = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Capture Ship", "Helm", __name__ + ".CaptureShip",
                                                                    mTransferSubMenu)
        kCaptureShip = DS9FXLib.DS9FXMenuLib.ColorizeButton(bCaptureShip, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0,
                                                            0.25, 0.25, 0.25, 1.0)
    ...
    if DS9FXSavedConfig.FederationSide == 1:
        if DS9FXSavedConfig.DominionSide == 1:
            if DS9FXSavedConfig.Starbase375Starbase == 1:
                mS375SubMenu = DS9FXLib.DS9FXMenuLib.CreateSubMenu(mHelm, "Starbase 375 Options...")
                bDockTOS375 = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Dock To Starbase 375", "Helm",
                                                                           __name__ + ".DockToS375", mS375SubMenu)
                kDockTOS375 = DS9FXLib.DS9FXMenuLib.ColorizeButton(bDockTOS375, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0,
                                                                   1.0, 0.25, 0.25, 0.25, 1.0)
            else:
                print "DS9FX: Starbase 375 has not been enabled, docking functions won't initialize"
            if DS9FXSavedConfig.DS9Selection == 1:
                mDS9SubMenu = DS9FXLib.DS9FXMenuLib.CreateSubMenu(mHelm, "DS9 Options...")
                bDockToDS9 = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Dock To DS9", "Helm",
                                                                          __name__ + ".DockToDS9", mDS9SubMenu)
                kDockToDS9 = DS9FXLib.DS9FXMenuLib.ColorizeButton(bDockToDS9, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0,
                                                                  0.25, 0.25, 0.25, 1.0)
            else:
                print "DS9FX: DS9 has not been enabled, docking functions won't initialize"
    ...
    bEnter = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Enter Wormhole", "Helm", __name__ + ".EnterSeq",
                                                          mWormholeSubMenu)
    kEnter = DS9FXLib.DS9FXMenuLib.ColorizeButton(bEnter, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25, 0.25,
                                                  1.0)
    bExitToGamma = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Exit To Gamma", "Helm", __name__ + ".ExitToGammaSeq",
                                                                mWormholeSubMenu)
    kExitToGamme = DS9FXLib.DS9FXMenuLib.ColorizeButton(bExitToGamma, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25,
                                                        0.25, 0.25, 1.0)
    bExitToDS9 = DS9FXLib.DS9FXMenuLib.CreateBridgeMenuButton("Exit To DS9", "Helm", __name__ + ".ExitToDS9Seq",
                                                              mWormholeSubMenu)
    kExitToDS9 = DS9FXLib.DS9FXMenuLib.ColorizeButton(bExitToDS9, 0.5, 0.5, 1.0, 1.0, 0.61, 0.61, 1.0, 1.0, 0.25, 0.25,
                                                      0.25, 1.0)
    ...
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow",
                           App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow2",
                           App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow3",
                           App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow4",
                           App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CreateWindow5",
                           App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
    ...
    App.g_kEventManager.AddBroadcastPythonFuncHandler(ET_WINDOW_CLOSE_4, pMission, __name__ + ".Window5")
    ...
    pPerson.AddPythonFuncHandlerForInstance(ET_TRUE_WAY_1, __name__ + ".TrueWayMission1")
    pPerson.AddPythonFuncHandlerForInstance(ET_TRUE_WAY_2, __name__ + ".TrueWayMission2")
    pPerson.AddPythonFuncHandlerForInstance(ET_TRUE_WAY_3, __name__ + ".TrueWayMission3")
    pPerson.AddPythonFuncHandlerForInstance(ET_TRUE_WAY_4, __name__ + ".TrueWayMission4")
    pPerson.AddPythonFuncHandlerForInstance(ET_TRUE_WAY_5, __name__ + ".TrueWayMission5")
    ...
    pPerson.AddPythonFuncHandlerForInstance(App.ET_CHARACTER_MENU, __name__ + ".CloseWindow5")
...
def EnterSeq(pObject, pEvent):
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "CutsceneCameraBegin",
                                                         pPlayer.GetContainingSet().GetName()))
        pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "DropAndWatch",
                                                         pPlayer.GetContainingSet().GetName(), pPlayer.GetName()))
        pSequence.Play()

        DS9FXGlobalEvents.Trigger_Pre_Wormhole_Entry(MissionLib.GetPlayer())
        ...
        ScaleDistanceTimer = DS9FXLib.DS9FXMenuLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(),
                                                               __name__ + ".ScaleWormholeDistanceCheck",
                                                               App.g_kUtopiaModule.GetGameTime() + 0.1)
...
def ExitToDS9Seq(pObject, pEvent):
    ...
    if (pSet.GetName() == "BajoranWormhole1"):
        ...
        pSequence.AppendAction(
            App.TGScriptAction_Create("Actions.CameraScriptActions", "ChaseCam", pPlayer.GetContainingSet().GetName(),
                                      pPlayer.GetName()))
        pSequence.Play()

        DisableEngineerMenu()

        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".ExitToDS9Seq2",
                               App.g_kUtopiaModule.GetGameTime() + 5, 0, 0)
    else:
        pass
...
def ExitToDS9Seq3(pObject, pEvent):
    ...
    pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "StartCinematicMode", 0))
    pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "CutsceneCameraBegin",
                                                     pNewPlayer.GetContainingSet().GetName()))
    pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "DropAndWatch",
                                                     pNewPlayer.GetContainingSet().GetName(), "Bajoran Wormhole"))
    pSequence.Play()
    ...
    ExitingScaleTimer = MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(),
                                               __name__ + ".ExitingWormholeScaling",
                                               App.g_kUtopiaModule.GetGameTime() + 5, 0, 0)
...
def ExitBackToDS9(pObject, pEvent):
    ...
    if (pSet.GetName() == "BajoranWormhole1"):
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CheckVideoExitingDS9",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
...
def ExitToGammaSeq(pObject, pEvent):
    ...
    if (pSet.GetName() == "BajoranWormhole1"):
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".ExitToGammaSeq2",
                               App.g_kUtopiaModule.GetGameTime() + 5, 0, 0)
...
def GlobalCutsceneEnding(pObject, pEvent):
    ...
    pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "CutsceneCameraEnd",
                                                     pPlayer.GetContainingSet().GetName()))
...
def ExitBackToGamma(pObject, pEvent):
    ...
    if (pSet.GetName() == "BajoranWormhole1"):
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CheckVideoExitingGamma",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
...
def EnterCheck(pObject, pEvent):
    ...
    DistanceCheckCondition = App.ConditionScript_Create("Conditions.ConditionInRange", "ConditionInRange", iDistance,
                                                        pPlayer.GetName(), pDS9FXWormhole)
...
def ScaleWormholeDistanceCheck(pObject, pEvent):
    ...
    if DistanceCheck(pDS9FXWormhole) <= 40:
        ...
        pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "CutsceneCameraBegin",
                                                         pPlayer.GetContainingSet().GetName()))
        pSequence.AppendAction(App.TGScriptAction_Create("Actions.CameraScriptActions", "TargetWatch",
                                                         pPlayer.GetContainingSet().GetName(), pPlayer.GetName(),
                                                         "Bajoran Wormhole"))
        pSequence.Play()
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".ScaleWormhole",
                               App.g_kUtopiaModule.GetGameTime() + 2, 0, 0)
        ...
        ScaleDistanceTimer = DS9FXLib.DS9FXMenuLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(),
                                                               __name__ + ".ScaleWormholeDistanceCheck",
                                                               App.g_kUtopiaModule.GetGameTime() + 0)
...
def Enter(pObject, pEvent):
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".TransferShips",
                               App.g_kUtopiaModule.GetGameTime() + 0.1, 0, 0)
...
def HandleRandomAttackTimer():
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        if DS9FXSavedConfig.RandomEnemyFleetAttacks == 1:
            RandomAttackTimer = DS9FXLib.DS9FXMenuLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(),
                                                                  __name__ + ".EnemyFleetArrives",
                                                                  App.g_kUtopiaModule.GetGameTime() + RandomEnemyFleet)
    else:
...
def ActivateDS9FXButtons():
    global bEnter, bExitToGamma, bExitToDS9, bDockToDS9, bHail, bCloseChannel, bKaremma, bFounders, bKurrill, bIdran, bDosi, bVandros, bGaia, bYadera, bNewBajor, bTrialus, bTRogoran, bDockTOS375
    global iOverflow
    if iOverflow == 1:
        return
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        iOverflow = 1
        RestoreiOverflowAction()
    elif (pSet.GetName() == "DS9FXStarbase3751"):
        if (bDockTOS375 != None):
            bDockTOS375.SetEnabled()
...
def TransferShips(pObject, pEvent):
    ...
    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".DeleteDummy",
                           App.g_kUtopiaModule.GetGameTime() + 4, 0, 0)

    if Timer == 5:
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".EnterSeq3",
                               App.g_kUtopiaModule.GetGameTime() + Timer, 0, 0)

    else:
        ReturnKeyboardControl()

    InsideWormholeTimer = DS9FXLib.DS9FXMenuLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(),
                                                            __name__ + ".InsideWormholeDistanceCheck",
                                                            App.g_kUtopiaModule.GetGameTime() + 10)
...
def TransferShips3(pObject, pEvent):
    ...
    if DS9FXSavedConfig.DomIS == 1:
        ...
        if pEnemies.IsNameInGroup("Bugship 1") or pEnemies.IsNameInGroup("Bugship 2") or pEnemies.IsNameInGroup(
                "Bugship 3"):
            if APShip:
                MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".AntiprotonScan",
...
def ScaleWormhole(pObject, pEvent):
    ...
    if Scale >= 4:
        ...
        ScaleTimer = MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".ScaleWormhole",
                                            App.g_kUtopiaModule.GetGameTime() + 0.05, 0, 0)
...
def AntiprotonScan(pObject, pEvent):
    ...
    pCurrMission = pCurrEpisode.GetCurrentMission()
    pEnemies = pCurrMission.GetEnemyGroup()
    if not pEnemies.IsNameInGroup("Bugship 1") or not pEnemies.IsNameInGroup("Bugship 2") or not pEnemies.IsNameInGroup(
            "Bugship 3"):
        reload(DS9FXSavedConfig)
        if DS9FXSavedConfig.DomIS == 1:
            if APShip:
...
def BuildFirepoint(pObject):
    ...
    App.g_kEventManager.AddBroadcastPythonFuncHandler(App.ET_DECLOAK_BEGINNING, pMission,
                                                      __name__ + ".ObjectDecloaking")
    App.g_kEventManager.AddBroadcastPythonFuncHandler(App.ET_OBJECT_EXPLODING, pMission, __name__ + ".ObjectExploding")

    MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".DeleteFirepoint",
                           App.g_kUtopiaModule.GetGameTime() + 40, 0, 0)

    AttachTimer = MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".AttachFirepoint",
                                         App.g_kUtopiaModule.GetGameTime() + 5, 0, 0)
...
def FelixWarnPrompt(pObject=None, pEvent=None):
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pTactical, App.CharacterAction.AT_SAY_LINE, "WarnPrompt", None, 0, Database))
    pSequence.Play()
...
def ImpulsePrompt(pObject=None, pEvent=None):
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pEng, App.CharacterAction.AT_SAY_LINE, "Impulse", None, 0, Database))
    pSequence.Play()
...
def EnemyFleetArrives(pObject, pEvent):
    ...
    if (pSet.GetName() == "DeepSpace91"):
        ...
        pTactical = App.CharacterClass_GetObject(pSet, "Tactical")
        pSequence.AppendAction(
            App.CharacterAction_Create(pTactical, App.CharacterAction.AT_SAY_LINE, "EnemiesEnteringTheSet", None, 0,
                                       Database))
        pSequence.Play()
...
def DockToDS9(pObject, pEvent):
    ...
    MissionLib.SetPlayerAI("Helm",
                           Custom.DS9FX.DS9FXAILib.DS9FXDockToDS9.CreateAI(pPlayer, pDS9, pDockingAction, bNoRepair=0,
                                                                           bFadeEnd=1))


def DockToS375(pObject, pEvent):
    pPlayer = App.Game_GetCurrentPlayer()
    if (pPlayer is None):
        return 0
    pBase = GetS375(pPlayer)
    if (pBase is None):
        return 0
    pDockingAction = None
    import AI.Compound.DockWithStarbase
    MissionLib.SetPlayerAI("Helm", AI.Compound.DockWithStarbase.CreateAI(pPlayer, pBase, pDockingAction, bNoRepair=0,
                                                                         bFadeEnd=1))
...
def GetS375(pShip):
    if pShip:
        ...
        if (pSet is None):
            return None
        pBase = MissionLib.GetShip("Starbase 375", pSet)
        if (pBase is None):
            return None
        return pBase
    else:
...
def PlayerDetected(pObject=None, pEvent=None):
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pXO, App.CharacterAction.AT_SAY_LINE, "CloakDetect", None, 0, Database))
    pSequence.Play()
...
def WelcomeToDS9Line(pObject=None, pEvent=None):
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pKira, App.CharacterAction.AT_SAY_LINE, "welcome", None, 0, Database))
    pSequence.Play()
...
def ChooseCampaign3(pObject, pEvent):
    RemoveWindow5Contents(None, None)
    CreateWindow5PartII(None, None)
    Window5(None, None)
...
def RemoveWindow5Contents(pObject, pEvent):
    global MissionWindow5, dTrueWay

    if MissionWindow5:
        for k in dTrueWay.keys():
            MissionWindow5.DeleteChild(dTrueWay[k])
...
def HandleResolutionForUI(window):
...
def CreateWindow(pObject, pEvent):
    ...
    MissionWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                                 App.TGString("Campaign Mission Selection Menu"), 0.0, 0.0, None, 1,
                                                 0.50, 0.65, kColor)

    HandleResolutionForUI(MissionWindow)
...
def CreateWindow2(pObject, pEvent):
    ...
    MissionWindow2 = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                                  App.TGString("Mini Mission Selection Menu"), 0.0, 0.0, None, 1, 0.50,
                                                  0.65, kColor)

    HandleResolutionForUI(MissionWindow2)
...
def CreateWindow3(pObject, pEvent):
    ...
    MissionWindow3 = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                                  App.TGString("Historic Mission Selection Menu"), 0.0, 0.0, None, 1,
                                                  0.50, 0.65, kColor)

    HandleResolutionForUI(MissionWindow3)
...
def CreateWindow4(pObject, pEvent):
    ...
    MissionWindow4 = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                                  App.TGString("Campaign Mission Selection Menu"), 0.0, 0.0, None, 1,
                                                  0.50, 0.65, kColor)
    HandleResolutionForUI(MissionWindow4)
...
def CreateWindow5(pObject, pEvent):
    global MissionWindow5
    ...
    MissionWindow5 = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize",
                                                  App.TGString("Campaign Mission Selection Menu"), 0.0, 0.0, None, 1,
                                                  0.50, 0.65, kColor)

    HandleResolutionForUI(MissionWindow5)

    MissionWindow5.AddPythonFuncHandlerForInstance(App.ET_MOUSE, __name__ + ".MousePass")
    MissionWindow5.SetNotVisible()
...
def CreateWindowPartII(pObject, pEvent):
    ...
    try:
        ...
        if Ship == None:
            ...
            MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CloseChannels",
                                   App.g_kUtopiaModule.GetGameTime() + 0.1, 0, 0)
            return
        MissionProgress = 1
    except:
    ...
    x = 0
    y = 0.01
    dBorderSkirmish['6'] = App.TGParagraph_CreateW(App.TGString(
        "Please Select a Mission. Remember that the Campaign Mode remembers your last used ship and you cannot switch ships later. Missions have to be unlocked one by one."),
        MissionWindow.GetMaximumInteriorWidth(), None, '',
        MissionWindow.GetMaximumInteriorWidth(),
        App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow.AddChild(dBorderSkirmish['6'], x, y, 0)

    textx = 0
    texty = 0.10
    dBorderSkirmish['1'] = App.TGParagraph_CreateW(App.TGString("Mission 1: Patrol Duty"),
                                                   MissionWindow.GetMaximumInteriorWidth(), None, '',
                                                   MissionWindow.GetMaximumInteriorWidth(),
                                                   App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dBorderSkirmish['2'] = App.TGParagraph_CreateW(App.TGString("Mission 2: Investigations"),
                                                   MissionWindow.GetMaximumInteriorWidth(), None, '',
                                                   MissionWindow.GetMaximumInteriorWidth(),
                                                   App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dBorderSkirmish['3'] = App.TGParagraph_CreateW(App.TGString("Mission 3: A Time To Fight"),
                                                   MissionWindow.GetMaximumInteriorWidth(), None, '',
                                                   MissionWindow.GetMaximumInteriorWidth(),
                                                   App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dBorderSkirmish['4'] = App.TGParagraph_CreateW(App.TGString("Mission 4: Revenge Is A Dish Best Served Cold"),
                                                   MissionWindow.GetMaximumInteriorWidth(), None, '',
                                                   MissionWindow.GetMaximumInteriorWidth(),
                                                   App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dBorderSkirmish['5'] = App.TGParagraph_CreateW(App.TGString("Mission 5: Once More Unto The Breach"),
                                                   MissionWindow.GetMaximumInteriorWidth(), None, '',
                                                   MissionWindow.GetMaximumInteriorWidth(),
                                                   App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
...
def CreateWindow2PartII(pObject, pEvent):
    ...
    x = 0
    y = 0.01
    dMiniMission['1'] = App.TGParagraph_CreateW(App.TGString(
        "Please Select a Mission. Unlike Campaign Mode you can freely pick any ship you wish! These are just small missions for fun."),
        MissionWindow2.GetMaximumInteriorWidth(), None, '',
        MissionWindow2.GetMaximumInteriorWidth(),
        App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow2.AddChild(dMiniMission['1'], x, y, 0)

    textx = 0
    texty = 0.10
    dMiniMission['2'] = App.TGParagraph_CreateW(App.TGString("Mission: Procure Ketracel White"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['3'] = App.TGParagraph_CreateW(App.TGString("Mission: Anomalous Readings"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['4'] = App.TGParagraph_CreateW(App.TGString("Mission: The tides of Idran"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['5'] = App.TGParagraph_CreateW(App.TGString("Mission: The Dogs of War"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['6'] = App.TGParagraph_CreateW(App.TGString("Mission: Valiant"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['7'] = App.TGParagraph_CreateW(App.TGString("Mission: Section 31"),
                                                MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                MissionWindow2.GetMaximumInteriorWidth(),
                                                App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['16'] = App.TGParagraph_CreateW(App.TGString("Mission: Secret Weapon"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['18'] = App.TGParagraph_CreateW(App.TGString("Mission: Rebels"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['20'] = App.TGParagraph_CreateW(App.TGString("Mission: Supplies"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['22'] = App.TGParagraph_CreateW(App.TGString("Mission: Black OPS"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['24'] = App.TGParagraph_CreateW(App.TGString("Mission: Disturbing Times"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['26'] = App.TGParagraph_CreateW(App.TGString("Mission: Section 31 Surprise"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['28'] = App.TGParagraph_CreateW(App.TGString("Mission: Dominion Intelligence"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['30'] = App.TGParagraph_CreateW(App.TGString("Mission: Patrol"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['32'] = App.TGParagraph_CreateW(App.TGString("Mission: Distress Call"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['34'] = App.TGParagraph_CreateW(App.TGString("Mission: Dominion Bases"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['36'] = App.TGParagraph_CreateW(App.TGString("Mission: Recover Derelict"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['38'] = App.TGParagraph_CreateW(App.TGString("Mission: Stop the War"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['40'] = App.TGParagraph_CreateW(App.TGString("Mission: Assistance"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['42'] = App.TGParagraph_CreateW(App.TGString("Mission: Scan"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['44'] = App.TGParagraph_CreateW(App.TGString("Mission: Missing Ship"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dMiniMission['46'] = App.TGParagraph_CreateW(App.TGString("Mission: Escort Service"),
                                                 MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                 MissionWindow2.GetMaximumInteriorWidth(),
                                                 App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    if DS9FXSavedConfig.EasterEggs == 1:
        textx = 0
        texty = texty + 0.06
        dMiniMission['48'] = App.TGParagraph_CreateW(App.TGString("Mission: Random Dominion Mission"),
                                                     MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                     MissionWindow2.GetMaximumInteriorWidth(),
                                                     App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        ...
        textx = 0
        texty = texty + 0.06
        dMiniMission['50'] = App.TGParagraph_CreateW(App.TGString("Mission: Random Borg Mission"),
                                                     MissionWindow2.GetMaximumInteriorWidth(), None, '',
                                                     MissionWindow2.GetMaximumInteriorWidth(),
                                                     App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
...
def CreateWindow3PartII(pObject, pEvent):
    ...
    x = 0
    y = 0.01
    dHistoric['1'] = App.TGParagraph_CreateW(App.TGString(
        "Please Select a Mission. Historic Mission Mode pays tribute to DS9. You can play a lot of historic missions seen in the show. All missions are available to you but your ship class varies from mission to mission."),
        MissionWindow3.GetMaximumInteriorWidth(), None, '',
        MissionWindow3.GetMaximumInteriorWidth(),
        App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow3.AddChild(dHistoric['1'], x, y, 0)

    textx = 0
    texty = 0.12
    dHistoric['2'] = App.TGParagraph_CreateW(App.TGString("Mission: Plant the minefield"),
                                             MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow3.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dHistoric['3'] = App.TGParagraph_CreateW(App.TGString("Mission: Retake DS9"),
                                             MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow3.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dHistoric['4'] = App.TGParagraph_CreateW(App.TGString("Mission: USS Odyssey"),
                                             MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow3.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dHistoric['5'] = App.TGParagraph_CreateW(App.TGString("Mission: Retake DS9 (Canon)"),
                                             MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow3.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dHistoric['6'] = App.TGParagraph_CreateW(App.TGString("Mission: The Way of the Warrior"),
                                             MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow3.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dHistoric['14'] = App.TGParagraph_CreateW(App.TGString("Mission: Save Odo"),
                                              MissionWindow3.GetMaximumInteriorWidth(), None, '',
                                              MissionWindow3.GetMaximumInteriorWidth(),
                                              App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
...
def CreateWindow4PartII(pObject, pEvent):
    ...
    x = 0
    y = 0.01
    dOldRivals['1'] = App.TGParagraph_CreateW(App.TGString(
        "Please Select a Mission. Remember that the Campaign Mode remembers your last used ship and you cannot switch ships later. Missions have to be unlocked one by one."),
        MissionWindow4.GetMaximumInteriorWidth(), None, '',
        MissionWindow4.GetMaximumInteriorWidth(),
        App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow4.AddChild(dOldRivals['1'], x, y, 0)

    textx = 0
    texty = 0.10
    dOldRivals['2'] = App.TGParagraph_CreateW(App.TGString("Mission 1: Patrol"),
                                              MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                              MissionWindow4.GetMaximumInteriorWidth(),
                                              App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['7'] = App.TGParagraph_CreateW(App.TGString("Mission 2: Elucidate"),
                                              MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                              MissionWindow4.GetMaximumInteriorWidth(),
                                              App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['9'] = App.TGParagraph_CreateW(App.TGString("Mission 3: Duplicity"),
                                              MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                              MissionWindow4.GetMaximumInteriorWidth(),
                                              App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['11'] = App.TGParagraph_CreateW(App.TGString("Mission 4: The Price of Betrayal"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['13'] = App.TGParagraph_CreateW(App.TGString("Mission 5: The Mission Continues"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['15'] = App.TGParagraph_CreateW(App.TGString("Mission 6: Equivocation"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['17'] = App.TGParagraph_CreateW(App.TGString("Mission 7: Humdrum"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['19'] = App.TGParagraph_CreateW(App.TGString("Mission 8: Trepidation"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['21'] = App.TGParagraph_CreateW(App.TGString("Mission 9: Elevation"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    ...
    textx = 0
    texty = texty + 0.06
    dOldRivals['23'] = App.TGParagraph_CreateW(App.TGString("Mission 10: Anticipation"),
                                               MissionWindow4.GetMaximumInteriorWidth(), None, '',
                                               MissionWindow4.GetMaximumInteriorWidth(),
                                               App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
...
def CreateWindow5PartII(pObj, pEvent):
    global ET_WINDOW_CLOSE_5, ET_TRUE_WAY_1, ET_BACK, MissionWindow5, pPerson, ET_UNAVAILABLE, ET_TRUE_WAY_2, ET_TRUE_WAY_3, dTrueWay, ET_TRUE_WAY_4, ET_TRUE_WAY_5
    ...
    x = 0
    y = 0.01
    dTrueWay['1'] = App.TGParagraph_CreateW(App.TGString(
        "Please Select a Mission. Remember that the Campaign Mode remembers your last used ship and you cannot switch ships later. Missions have to be unlocked one by one."),
        MissionWindow5.GetMaximumInteriorWidth(), None, '',
        MissionWindow5.GetMaximumInteriorWidth(),
        App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['1'], x, y, 0)

    textx = 0
    texty = 0.10
    dTrueWay['2'] = App.TGParagraph_CreateW(App.TGString("Mission 1: Pink Slips"),
                                            MissionWindow5.GetMaximumInteriorWidth(), None, '',
                                            MissionWindow5.GetMaximumInteriorWidth(),
                                            App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['2'], textx, texty, 0)

    x = 0.35
    y = y + 0.08
    pEvent = App.TGIntEvent_Create()
    pEvent.SetEventType(ET_TRUE_WAY_1)
    pEvent.SetDestination(pPerson)
    pEvent.SetInt(0)
    dTrueWay['3'] = CreateWindowButton(pEvent, "Mission Briefing")
    MissionWindow5.AddChild(dTrueWay['3'], x, y, 0)

    textx = 0
    texty = texty + 0.06
    dTrueWay['7'] = App.TGParagraph_CreateW(App.TGString("Mission 2: On the Border"),
                                            MissionWindow5.GetMaximumInteriorWidth(), None, '',
                                            MissionWindow5.GetMaximumInteriorWidth(),
                                            App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['7'], textx, texty, 0)
    if iProgress < 2:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        ...
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['8'] = CreateWindowButton(pEvent, "Mission Locked", 1)
        MissionWindow5.AddChild(dTrueWay['8'], x, y, 0)
    else:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        pEvent.SetEventType(ET_TRUE_WAY_2)
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['8'] = CreateWindowButton(pEvent, "Mission Briefing")
        MissionWindow5.AddChild(dTrueWay['8'], x, y, 0)

    textx = 0
    texty = texty + 0.06
    dTrueWay['9'] = App.TGParagraph_CreateW(App.TGString("Mission 3: Gunships"),
                                            MissionWindow5.GetMaximumInteriorWidth(), None, '',
                                            MissionWindow5.GetMaximumInteriorWidth(),
                                            App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['9'], textx, texty, 0)
    if iProgress < 3:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        ...
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['10'] = CreateWindowButton(pEvent, "Mission Locked", 1)
        MissionWindow5.AddChild(dTrueWay['10'], x, y, 0)
    else:

        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        pEvent.SetEventType(ET_TRUE_WAY_3)
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['10'] = CreateWindowButton(pEvent, "Mission Briefing")
        MissionWindow5.AddChild(dTrueWay['10'], x, y, 0)

    textx = 0
    texty = texty + 0.06
    dTrueWay['11'] = App.TGParagraph_CreateW(App.TGString("Mission 4: Payback"),
                                             MissionWindow5.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow5.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['11'], textx, texty, 0)
    if iProgress < 4:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        ...
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['12'] = CreateWindowButton(pEvent, "Mission Locked", 1)
        MissionWindow5.AddChild(dTrueWay['12'], x, y, 0)
    else:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        pEvent.SetEventType(ET_TRUE_WAY_4)
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['12'] = CreateWindowButton(pEvent, "Mission Briefing")
        MissionWindow5.AddChild(dTrueWay['12'], x, y, 0)

    textx = 0
    texty = texty + 0.06
    dTrueWay['13'] = App.TGParagraph_CreateW(App.TGString("Mission 5: The Battle of Septimus"),
                                             MissionWindow5.GetMaximumInteriorWidth(), None, '',
                                             MissionWindow5.GetMaximumInteriorWidth(),
                                             App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
    MissionWindow5.AddChild(dTrueWay['13'], textx, texty, 0)
    if iProgress < 5:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        ...
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['14'] = CreateWindowButton(pEvent, "Mission Locked", 1)
        MissionWindow5.AddChild(dTrueWay['14'], x, y, 0)
    else:
        x = 0.35
        y = y + 0.06
        pEvent = App.TGIntEvent_Create()
        pEvent.SetEventType(ET_TRUE_WAY_5)
        pEvent.SetDestination(pPerson)
        pEvent.SetInt(0)
        dTrueWay['14'] = CreateWindowButton(pEvent, "Mission Briefing")
        MissionWindow5.AddChild(dTrueWay['14'], x, y, 0)
    ...
    pEvent.SetDestination(pPerson)
    pEvent.SetInt(0)
    dTrueWay['4'] = CreateWindowButton(pEvent, "Back To Main Menu")
    MissionWindow5.AddChild(dTrueWay['4'], x, y, 0)
    ...
    pEvent.SetDestination(pPerson)
    pEvent.SetInt(0)
    dTrueWay['5'] = CreateWindowButton(pEvent, "Close Channel")
    MissionWindow5.AddChild(dTrueWay['5'], x, y, 0)

    MissionWindow5.InteriorChangedSize()
    MissionWindow5.Layout()
...
def Window(pObject, pEvent):
    global MissionWindow, MissionWindow2, MissionWindow3, MissionWindow4, MissionWindow5
    ...
    lWindows = [MissionWindow2, MissionWindow3, MissionWindow4, MissionWindow5]
    for pWindow in lWindows:
...
def Window2(pObject, pEvent):
    global MissionWindow2, MissionWindow, MissionWindow3, MissionWindow4, MissionWindow5
    ...
    lWindows = [MissionWindow, MissionWindow3, MissionWindow4, MissionWindow5]
    for pWindow in lWindows:
        if pWindow.IsVisible():
            pTCW.MoveToBack(pWindow)
            pWindow.SetNotVisible()
...
def Window3(pObject, pEvent):
    global MissionWindow3, MissionWindow, MissionWindow2, MissionWindow4, MissionWindow5
    ...
    lWindows = [MissionWindow, MissionWindow2, MissionWindow4, MissionWindow5]
    for pWindow in lWindows:
        if pWindow.IsVisible():
            pTCW.MoveToBack(pWindow)
            pWindow.SetNotVisible()
...
def Window4(pObject, pEvent):
    ...
    lWindows = [MissionWindow, MissionWindow2, MissionWindow3, MissionWindow5]
    for pWindow in lWindows:
        if pWindow.IsVisible():
            pTCW.MoveToBack(pWindow)
            pWindow.SetNotVisible()
...
def Window5(pObject, pEvent):
    global MissionWindow, MissionWindow2, MissionWindow3, MissionWindow4, MissionWindow5

    pTCW = App.TacticalControlWindow_GetTacticalControlWindow()

    if not MissionWindow5:
        if pObject and pEvent:
            pObject.CallNextHandler(pEvent)
        return

    lWindows = [MissionWindow, MissionWindow2, MissionWindow3, MissionWindow4]
    for pWindow in lWindows:
        if pWindow.IsVisible():
            pTCW.MoveToBack(pWindow)
            pWindow.SetNotVisible()

    if MissionWindow5.IsVisible():
        pTCW.MoveToBack(MissionWindow5)
        MissionWindow5.SetNotVisible()
        ...
        MissionWindow5.SetVisible()
        pTCW.MoveToFront(MissionWindow5)
        pTCW.MoveTowardsBack(MissionWindow5)
...
def CloseWindow5(pObject, pEvent):
    global MissionWindow5
...
def CloseChannels(pObject, pEvent):
    ...
    lWindows = [MissionWindow, MissionWindow2, MissionWindow3, MissionWindow4, MissionWindow5]
...
def TrueWayMission1(pObject, pEvent):
    PreMissionActions()

    from Custom.DS9FX.DS9FXMissions.CampaignMode.TrueWay import Mission1
    Mission1.Briefing()
...
def TrueWayMission2(pObject, pEvent):
    PreMissionActions()

    from Custom.DS9FX.DS9FXMissions.CampaignMode.TrueWay import Mission2
    Mission2.Briefing()
...
def TrueWayMission3(pObject, pEvent):
    PreMissionActions()

    from Custom.DS9FX.DS9FXMissions.CampaignMode.TrueWay import Mission3
    Mission3.Briefing()
...
def TrueWayMission4(pObject, pEvent):
    PreMissionActions()

    from Custom.DS9FX.DS9FXMissions.CampaignMode.TrueWay import Mission4
    Mission4.Briefing()
...
def TrueWayMission5(pObject, pEvent):
    PreMissionActions()

    from Custom.DS9FX.DS9FXMissions.CampaignMode.TrueWay import Mission5
    Mission5.Briefing()
...
def CheckVideoExitingDS9(pObject, pEvent):
    ...
    if VideoMode == 1:
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".TransferShips2",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
    else:
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CheckVideoExitingDS9",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
...
def CheckVideoExitingGamma(pObject, pEvent):
    ...
    if VideoMode == 1:
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".TransferShips3",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
    else:
        MissionLib.CreateTimer(DS9FXLib.DS9FXMenuLib.GetNextEventType(), __name__ + ".CheckVideoExitingGamma",
                               App.g_kUtopiaModule.GetGameTime() + 1, 0, 0)
