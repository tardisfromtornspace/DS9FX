...
def DialogueWarn():
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pCharacter, App.CharacterAction.AT_SAY_LINE, "StrikeForce", None, 0, pDatabase))
    pSequence.Play()
...
def DialogueEnemyArrival(pAction):
    ...
    pSequence.AppendAction(
        App.CharacterAction_Create(pCharacter, App.CharacterAction.AT_SAY_LINE, "EnemiesEnteringTheSet", None, 0,
                                   pDatabase))
    pSequence.Play()
