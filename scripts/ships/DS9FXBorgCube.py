...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/DS9FX/BorgCube/TNGBorgCube.nif",
		"FilenameMed": "data/Models/Ships/DS9FX/BorgCube/TNGBorgCube.nif",
		"FilenameLow": "data/Models/Ships/DS9FX/BorgCube/TNGBorgCube.nif",
		"Name": "DS9FXBorgCube",
		"HardpointFile": "DS9FXBorgCube",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10,  1250.0, 95.0, 95.0, 400, 900, "_glow", None, "_spec")
		pLODModel.AddLOD(pStats["FilenameMed"],  10,  2500.0, 95.0, 95.0, 400, 900, "_glow", None, "_spec")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 15000.0, 95.0, 95.0, 400, 900, "_glow", None, None)
