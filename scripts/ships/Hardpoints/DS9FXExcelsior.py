...
ShieldGenerator.SetPosition(0.000000, 0.800340, 0.223407)
...
SensorArray.SetPosition(0.000000, 0.636456, -0.293579)
...
WarpCore.SetPosition(0.000000, 0.292700, -0.438689)
...
Engineering.SetPosition(0.000000, 0.292700, -0.438689)
...
PortNacelle.SetPosition(-0.630000, -1.000000, 0.180000)
...
StarNacelle.SetPosition(0.630000, -1.000000, 0.180000)
...
PortImpulse.SetPosition(-0.164000, 0.400891, 0.195337)
...
StarImpulse.SetPosition(0.164000, 0.400891, 0.195337)
...
FwdTorpedo1.SetPosition(0.183866, 0.714991, -0.164137)
...
FwdTorpedo2.SetPosition(-0.183866, 0.714991, -0.164137)
...
AftTorpedo1.SetPosition(0.091205, -1.212700, -0.131118)
...
AftTorpedo2.SetPosition(-0.095000, -1.212700, -0.131118)
...
DorsalPhaser1.SetPosition(-0.278588, 1.690190, 0.206683)
...
DorsalPhaser2.SetPosition(0.383456, 1.428530, 0.206402)
...
DorsalPhaser3.SetPosition(-0.393352, 1.429790, 0.205154)
...
DorsalPhaser4.SetPosition(0.268760, 1.692190, 0.207531)
...
DorsalPhaser5.SetPosition(-0.001199, 1.798580, 0.208030)
...
DorsalPhaser5.SetMaxDamage(750.000000)
...
DorsalPhaser6.SetPosition(0.000000, -0.554806, 0.065043)
...
DorsalPhaser6.SetMaxDamage(750.000000)
...
VentralPhaser1.SetPosition(-0.274101, 1.352030, 0.048150)
...
VentralPhaser2.SetPosition(-0.248416, 1.598210, 0.046688)
...
VentralPhaser3.SetPosition(0.242174, 1.595180, 0.048756)
...
VentralPhaser4.SetPosition(0.277273, 1.350940, 0.048511)
...
VentralPhaser5.SetPosition(0.000839, 1.725720, 0.048668)
...
VentralPhaser6.SetPosition(0.053588, 0.327597, -0.428106)
...
VentralPhaser7.SetPosition(-0.060000, 0.327597, -0.428106)
...
VentralPhaser7.SetMaxDamage(750.000000)
...
VentralPhaser8.SetPosition(0.053758, 0.256570, -0.436180)
...
VentralPhaser8.SetMaxDamage(750.000000)
...
VentralPhaser9.SetPosition(-0.060000, 0.256570, -0.436180)
...
VentralPhaser9.SetMaxDamage(750.000000)
...
AftPhaser1.SetPosition(-0.021171, -1.374380, 0.022010)
...
AftPhaser2.SetPosition(0.021171, -1.374380, 0.022010)
...
ForwardTractor.SetPosition(0.000000, 1.023720, -0.108329)
...
AftTractor.SetPosition(0.000000, -1.168030, -0.131469)
...
ShuttleBay.SetPosition(0.000000, -1.470000, -0.017000)
...
ShuttleBayOEPPosition.SetXYZ(0.000000, -1.500000, -0.010000)
...
ProbeLauncherPosition.SetXYZ(0.183866, 0.714991, -0.164137)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 1.500000, 0.250000)
...
ViewscreenLeftPosition.SetXYZ(-0.959854, 1.500000, 0.100000)
...
ViewscreenRightPosition.SetXYZ(0.973556, 1.500000, 0.100000)
...
ViewscreenDownPosition.SetXYZ(0.000000, 1.400000, -0.100000)
...
FirstPersonCameraPosition.SetXYZ(0.000000, 1.500000, 0.250000)
