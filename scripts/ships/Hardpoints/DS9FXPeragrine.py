...
Hull.SetMaxCondition(5550.000000)
Hull.SetCritical(1)
...
SensorArray.SetBaseSensorRange(1650.000000)
...
WarpCore.SetMainConduitCapacity(520.000000)
WarpCore.SetBackupConduitCapacity(125.000000)
...
Peragrine.SetModelFilename("data/Models/Ships/DS9FX/Peragrine/Peragrine.nif")
...
PortPhaser.SetMaxCharge(0.750000)
PortPhaser.SetMaxDamage(500.000000)
PortPhaser.SetMaxDamageDistance(100.000000)
PortPhaser.SetMinFiringCharge(0.750000)
...
PortPhaser.SetMainRadius(0.010000)
PortPhaser.SetTaperRadius(0.005000)
...
PortPhaser.SetLengthTextureTilePerUnit(0.040000)
PortPhaser.SetPerimeterTile(1.000000)
PortPhaser.SetTextureSpeed(2.000000)
PortPhaser.SetTextureName("data/textures/tactical/P$YCH0s_Fed_DS9_Phaser.tga")
...
StarPhaser.SetMaxCharge(0.750000)
StarPhaser.SetMaxDamage(500.000000)
StarPhaser.SetMaxDamageDistance(100.000000)
StarPhaser.SetMinFiringCharge(0.750000)
