...
def CreateCharacter(pSet):
	...
	pKira.AddAnimation("CardstationSeated01", "Bridge.Characters.CommonAnimations.GlanceLeft")
	pKira.AddAnimation("CardstationSeated01", __name__ + ".Breathing")
...
def Breathing(pCharacter):
	...
	kAM.LoadAnimation ("data/animations/CardstationSeated01.nif", "CardassianStationSeated")
