...
def EB_interaction_tac(pCharacter):
	kAM = App.g_kAnimationManager
	...
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pAction = App.TGAnimAction_Create(pCharacter.GetAnimNode(), "EB_interaction_tac", 0, 0, 1)
	pSequence.AddAction(pAction, pOpenEyes)
	return pSequence
...
def EBPlaceAtH(pCharacter):
	...
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimPosition_Create(pAnimNode, "EB_seated_h_m")
	pSequence.AddAction(pAction)
	return pSequence
...
def EBPlaceAtC(pCharacter):
	...
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimPosition_Create(pAnimNode, "EB_seated_c_m")
	pSequence.AddAction(pAction)
	return pSequence
...
def EBPlaceAtX(pCharacter):
	...
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimPosition_Create(pAnimNode, "EB_seated_X_m")
	pSequence.AddAction(pAction)
	return pSequence
